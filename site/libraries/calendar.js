...
function Calendar(id, size, labelSettings, colors) {
  ...
  label = [ "Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado" ];
...
var calendar = new Calendar("calendarContainer", "fit", [ "Martes", 3 ], [ "#e91e63", "#c2185b", "#ffffff", "#f8bbd0" ]);
